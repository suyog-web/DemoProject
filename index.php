...
<html lang="en">
  ...
  <body>
    ...
    <!-------------------Baner Start Here....----------------------->
    <section class="h-baner">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <p class="b-title">All Shop In One Place</p>
            <p>Duis aute irure dolor in reprehenderit in voluptate velit esse
              cillum dolore eu fugiat nulla pariatur.Excepteur sint occaecat
              cupidatat non proident, sunt in culpa qui officia deserunt mollit
              anim id est laborum.quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea
              commodo
              consequat.</p>
          </div>
          <div class="col-md-6 text-center">
            <img src="./image/shop.png" class="img-fluid">
          </div>
        </div>
      </div>
      <svg id="svg" xmlns="http://www.w3.org/2000/svg" viewBox="-300 0 950 270">
        <path d="M-314,267 C105,364 400,100 812,279" fill="none" stroke="white"
          stroke-width="120" stroke-linecap="round" />
        </svg>
      </section>
      ...
      <section class="c-content">
        <div class="l-content">
          <img src="./image/pngtree.png">
        </div>
        <div class="r-content">
          <h1 class="c-head">About ShopWorld</h1>
          <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Lorem ipsum dolor
            ...
            quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea
            commodo
            consequat. <a href="./about_us.html">Read More...</a>
          </p>
        </div>
      </section>

      <!----------------------Our Client Section------------------------>
      <section class="o-client">
        <div class="container">
          <hr>
          <h1 class="client-head">Our Client</h1>
          <div id="carouselExampleControls" class="carousel slide"
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <div class="row">
                  <div class="col-3">
                    <img class="d-block" src="./image/client/chartz.png"
                      alt="First slide"></div>
                  <div class="col-3">
                    <img class="d-block" src="./image/client/client3.png"
                      alt="Second slide"></div>
                  <div class="col-3">
                    <img class="d-block" src="./image/client/client7.png"
                      alt="Third slide"></div>
                  <div class="col-3">
                    <img class="d-block" src="./image/client/designx.png"
                      alt="First slide">
                  </div>
                </div>
              </div>
              <div class="carousel-item">
                <div class="row">
                  <div class="col-3">
                    <img class="d-block"src="./image/client/devtech.png"
                      alt="Second slide"></div>
                  <div class="col-3">
                    <img class="d-block" src="./image/client/logic.png"
                      alt="Third slide"></div>
                  <div class="col-3">
                    <img class="d-block" src="./image/client/logo-target.png"
                      alt="First slide"></div>
                  <div class="col-3">
                    <img class="d-block" src="./image/client/logo-zeina.png"
                      alt="Second slide">
                  </div>
                </div>
              </div>
